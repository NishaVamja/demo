    ...
    render() {
        ...
        return (
            <div>
                ...
                <AddPlayer isOpen={this.state.modal} toggle={this.toggle} />
                </div>
                <Table  hover>
                    ...
                    <tbody>
                        {this.props.showplayer.map((player)=>{
                           ...
                           return (
                            ...
                            <td>{player.score}</td>
                            <td><Button color='primary' style={{marginRight:'10px'}} isOpen={this.state.modal} toggle={this.toggle}>Edit</Button>
