        ...
        return (
            <Container>
                ...
                <Modal isOpen={this.props.isOpen} toggle={this.props.toggle} className={this.props.className}>
                    ...
                    <ModalBody>
                        <Form>
                            <FormGroup>
                                ...
                                <Input type="text" name="fname"  placeholder="Enter FirstName" onChange={this.onFnamechange.bind(this)} />
                            </FormGroup>
                            <FormGroup>
                    ...
                    <ModalFooter>
                        {this.props.edata.id?<Button color="primary" onClick={this.AddPlayerdata}>Update</Button>:<Button color="primary" onClick={this.AddPlayerdata}>Submit</Button>}
