...
class AddPlayer extends Component {
    ...
    onFnamechange(e) {
        ...
        this.setState({...this.state, player: { firstName: e.target.value } })
        console.log('state',this.state)
    }
    onLnamechange(e) {
        console.log('lname',e.target.value);
        this.setState({...this.state, player: { lastName: e.target.value } })
        console.log('state',this.state)
    }
    onScorechange(e) {
        this.setState({ player: {...this.state.pla, score: e.target.value } })
        console.log('state',this.state)
    }
    render() {
        return (
