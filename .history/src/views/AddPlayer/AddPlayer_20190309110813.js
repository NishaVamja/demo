                    ...
                    <ModalBody>
                        <Form>
                            <FormGroup>
                                ...
                                <Input type="text" name="fname" defaultValue value={player.firstName} placeholder="Enter FirstName" onChange={this.onFnamechange.bind(this)} />
                            </FormGroup>
                            <FormGroup>
                                <Label >Last Name</Label>
                                <Input type="text" name="lname" value={player.lastName}  placeholder="Enter LastName" onChange={this.onLnamechange.bind(this)} />
                            </FormGroup>
                            <FormGroup>
                                <Label >Score</Label>
                                <Input type="number" name="score" value={player.score} placeholder="Enter Score" min='1' max='100' onChange={this.onScorechange.bind(this)} />
                            </FormGroup>
                        </Form>
                    </ModalBody>
                    <ModalFooter>
